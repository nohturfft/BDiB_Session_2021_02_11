...
### Check the R version  
RStudio Server Pro allows us to choose from different (older) versions of R.  
The following code chunk checks that we are using the latest version:  

```{r Check R version, warning=FALSE}
if (grepl("Linux stats3", system("uname -a", intern=T))) {
  if (R.version$version.string != "R version 4.0.2 (2020-06-22)"){
...
### Interactive graphic  
```{r plotly graphic, warning=FALSE}
